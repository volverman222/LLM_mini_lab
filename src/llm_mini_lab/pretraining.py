...
Usage from terminal (after ``pip install -e .``):
    python -m llm_mini_lab.pretraining
    python -m llm_mini_lab.pretraining --dataset fineweb
    python -m llm_mini_lab.pretraining --dataset fineweb --max_docs 2000 --epochs 1
...
def main(epochs=None, batch_size=2, max_length=None, eval_freq=None, eval_iter=1,
         ...
         verdict_path="data/the-verdict.txt",
         output_path="checkpoints/gpt2-pretrained.pth"):
    ...
    if dataset == "fineweb":
        ...
        text_data = download_verdict(verdict_path)
        train_ratio = 0.90
...
if __name__ == "__main__":
    ...
    parser.add_argument("--verdict_path", type=str,
                        default="data/the-verdict.txt")
    parser.add_argument("--output_path", type=str,
                        default="checkpoints/gpt2-pretrained.pth")
    ...
    main(epochs=args.epochs, batch_size=args.batch_size,
         ...
         verdict_path=args.verdict_path, output_path=args.output_path)
